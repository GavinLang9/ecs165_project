...
class Query:
    ...
    def select_version(self, search_key, search_key_index, projected_columns_index, relative_version):
        ...
        for i, record in enumerate(tail_record_list):
            ...
            final_records.append(Record(current_record.rid, current_record.indirection, current_record.tps, current_record.schema_encoding, current_record.key, tmp_columns))
